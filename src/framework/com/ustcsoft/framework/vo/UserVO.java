...
public class UserVO extends BaseVO{
	...
	private String tel;
	private String UserShenFenZhengHao;
	private String quNianJinRi;
	private String jinNianNianFen;
	private String quNianNianFen;
	/**
	 * 用户类别 0：正常用户；1：公章用户；2：外部系统用户
	 */
	private String userType;
	public String getUserShenFenZhengHao() {
		return UserShenFenZhengHao;
	}

	public void setUserShenFenZhengHao(String userShenFenZhengHao) {
		UserShenFenZhengHao = userShenFenZhengHao;
	}
	...
	/**
	 * @param isPrintGongZhang 要设置的 isPrintGongZhang
	 */
	...
	public String getQuNianJinRi() {
		return quNianJinRi;
	}

	public void setQuNianJinRi(String quNianJinRi) {
		this.quNianJinRi = quNianJinRi;
	}

	public String getJinNianNianFen() {
		return jinNianNianFen;
	}

	public void setJinNianNianFen(String jinNianNianFen) {
		this.jinNianNianFen = jinNianNianFen;
	}

	public String getQuNianNianFen() {
		return quNianNianFen;
	}

	public void setQuNianNianFen(String quNianNianFen) {
		this.quNianNianFen = quNianNianFen;
	}
